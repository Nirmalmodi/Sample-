...
TOKEN = '7419305617:AAFQYQE9TSTymADU2dSZDQj_AkwhnvgHulY'
...
FORWARD_CHANNEL_ID = -1002239144419
CHANNEL_ID = -1002239144419
error_channel_id = -1002239144419
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*Contact admin @No_erro*", parse_mode='Markdown')
    else:
